...
void AASBossCharacter::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>&Out)const{Super::GetLifetimeReplicatedProps(Out);DOREPLIFETIME(AASBossCharacter,Phase);DOREPLIFETIME(AASBossCharacter,DestroyedWeakPoints);}
