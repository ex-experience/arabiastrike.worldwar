...
void AASMissionDirector::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>&O)const{Super::GetLifetimeReplicatedProps(O);DOREPLIFETIME(AASMissionDirector,Phase);DOREPLIFETIME(AASMissionDirector,RequiredHostages);DOREPLIFETIME(AASMissionDirector,RescuedHostages);}
