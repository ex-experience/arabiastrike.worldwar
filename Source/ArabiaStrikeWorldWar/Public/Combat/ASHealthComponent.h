...
protected:
    ...
    UPROPERTY(ReplicatedUsing=OnRep_Health, VisibleInstanceOnly, Category="Health")
    float Health = 100.f;

    UFUNCTION() void HandleOwnerTakeAnyDamage(AActor* DamagedActor, float Damage, const UDamageType* DamageType,
