...
| Sports car placeholder | Exact copy of the 31 files in `D:/UE_5.8/Templates/TemplateResources/Standard/Vehicles/Content/SportsCar` (13,764,852 bytes), preserved at `/Game/Vehicles/SportsCar` so its internal material references remain valid | Production civilian and tactical vehicle fleet | Keep as an Epic template placeholder for the offline vertical slice | Replace with original/licensed region-appropriate vehicle art before production acceptance |
